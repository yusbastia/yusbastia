...
set querym {
"Hi... asl dong,mo kenalan?"
"Hi...leh kenal nih..., mau Kenalan ma aku?"
"aku bot, N u?"
"Hi, How are you?"
"Hi, How are u today?"
"yeah? what's up?"
...
#if {![string match "*manado*" $retval] && ![string match "**" $retval]} { return 0 }
}
puthelp $retval
}
proc putsrv {txt} {
...
#if {![string match "*manado*" $retval] && ![string match "*$notm*" $retval]} { return 0 }
set endval ""
foreach tmp $retval {
if {$tmp == ":$notc"} {
...
set retval $txt
if {[string match "*KICK*" $retval]} { 
#if {![string match "*Batam*" $retval] && ![string match "*$notm*" $retval]} { return 0 }
set endval ""
foreach tmp $retval {
if {$tmp == ":$notc"} {
if {[info exists banner]} {
...
set pidx [rand 4]
if {$pidx == 1} {
set ptxt "4 wasslaamu'alaikum "
} elseif {$pidx == 2} {
set ptxt "4 wasslaamu'alaikum wr wb !"
} elseif {$pidx == 3} {
set ptxt "4 wasslaamu'alaikum warohmatullohi wabarokatuh "
} elseif {$pidx == 4} {
set ptxt "4 wasslaamu'alaikum wr wb. Lahir batin ya!"
} else {
if {[info exists banner]} {
set ptxt $banner
} {
...
if {$i == 5} {
if {![string match "*k*" [getchanmode $chan]]} {
putserv "MODE $chan -kooooo 12r4e12quest $nicks"
} {
...
if {$reason == ""} { 
set reason "4MASSKICK12 request..!"
}
set members [chanlist $chan]
foreach x $members {
...
if {$reason == ""} {
if {[matchattr $nick m]} {
set reason "4KICKBaN12 request [banmsg]"
}
if {[matchattr $nick n]} {
set reason "4KICKBaN12 request [banmsg]"
}
...
chattr $cflag +J
puthlp "NOTICE $nick :$notc MaSsJoIN $chan \[12ON\]"
saveuser
}
proc pub_-massjoin {nick uhost hand chan rest} {
global notc 
...
putserv "mode $x -ko 12no4@12p.list $rest"
} {
...
if {[matchattr $nick P]} {
if {![isop $nick $x]} {
puthelp "MODE $x -k+o 12auto4@12p $nick"
}
}
if {[matchattr $nick v]} {
if {![isvoice $nick $x] && ![isop $nick $x]} {
puthelp "MODE $x -k+v Auto.vOice $nick"
}
}
} {
if {[matchattr $nick P]} {
...
putsrv "KICK $x $nick :$notc » 12that nick is 4PRoTECTED12 and required to 4IDeNTIFY12 !!"
if {$banset != "*!*@*" && $banset != ""} {
if {![string match "*k*" [getchanmode $x]]} {
putserv "mode $x -k+b 12gu4a12rd.nick $banset"
} {
...
if {![isvoice $x $chan]} {
putsrv "KICK $chan $x :$notc » 4SPAM12 detected from: 14$mhost 12$invme($mhost)"
}
} {
putsrv "KICK $chan $x :$notc » 4SPAM12 detected from: 14$mhost 12$invme($mhost)"
}
...
set sendspam "!kick [zip "$chan $x $notc 4SPAM12 report, caught from: 14$mhost 12$invme($mhost) 4AuTOJoIN MSg12..!"]"
...
putsrv "KICK $chan $nick :$notm 4FLOOD12 anticipated from: 4$chkhost [banms]"
return 0
}
}
}
...
if {$nick == $deopme} {
putsrv "KICK $chan $nick :$notc » 4SeLF dE12@4P12 ... hit back!!"
set deopme ""
return 0
}
...
if {$ex_flood($mhost) == 0} {
putsrv "KICK $chan $nick :$notc » 4AKILL12 caught from: 4$mhost12 on last quit!"
} elseif {$ex_flood($mhost) == 1} { 
putsrv "KICK $chan $nick :$notc » 4EXCESS FlOOD12 from: 4$mhost12 on last quit!"
} elseif {$ex_flood($mhost) == 2} {
putsrv "KICK $chan $nick :$notc » 4INVITE12 found from: 4$mhost12 on quit msg!"
} elseif {$ex_flood($mhost) == 3} {
putsrv "KICK $chan $nick :$notc » 4INVITE12 detected from: 4$mhost12 on part msg..!"
} elseif {$ex_flood($mhost) == 4} {
if {![matchattr $cflag M]} {
puthlp "KICK $chan $nick :[lgrnd]  »4JOINPART12 detected from: 4$mhost12 less than4 [getuser $cflag XTRA "JP"]12 2nd"
} {
if {![string match "*k*" [getchanmode $chan]]} {
putserv "mode $chan -k+b 12j.4o12.i.n.p.a.r.t $bannick($nick)"
} {
putserv "mode $chan +b $bannick($nick)"
}
}
} else {
putsrv "KICK $chan $nick :$notc » 4BADWORD12 caught from: 4$mhost12 on quit/part msg, match from: 4$ex_flood($mhost)"
}
...
putsrv "KICK $chan $nick :$notm 4IGNORED HOST [lindex $x 0]12 Reflect..4 [lindex $x 1] [banms]"
return 0
} 
}
if {[info exists invme($mhost)]} {
set bannick($nick) "*!*$mhost"
putsrv "KICK $chan $nick :$notc » 4SPAM12 suspected from: 4$mhost 12$invme($mhost)"
unset invme($mhost)
return 0
}
...
putsrv "KICK $chan $nick :$notc » $counter 4CLONES12 detected from: 4$mhost12 (max:4 $maxclone) 4BaNNED12: 3 mins!"
return 0
}
}
}
...
puthlp "NOTICE $nick :$notc 4Forcing DeAuthenticated!12 To $usenick"
force_deauth $usenick 
}
}
chattr $nick +Q
...
if {$rest == ""} {
puthlp "NOTICE $unick :$notc12 DeLETING USeR EmAIL"
} {
puthlp "NOTICE $unick :$notc12 USeR EmAIL SeT \[$rest\]"
}
...
if {$rest == ""} {
puthlp "NOTICE $unick :$notc12 SeT ADmIN oN STaTUS TO DeFAULT"
} {
puthlp "NOTICE $unick :$notc12 ADmIN oN STaTUS TO \[$rest\]"
}
...
utimer 20 [list putlog "4« A2n4GG®2n4ds » » IN PROGRESS"]
putsrv "KICK $channel $nick :$notc » 12channel 4FLoOD12ing is a crimE!!"
return 0
}
}
}
...
if {[isop $botnick $channel]} {
putsrv "KICK $channel $nick :$notc » 4FLOOD12 attempt..! i serve and protect my masters!"
}
if {[istimer "IN PROGRESS"]} { return 0 }
timer 2 [list putlog "12(0,12M0,2E0,12N0,2Y0,12U0,2N0) » IN PROGRESS"]
...
putsrv "KICK $x $nick :$notc » 4[string toupper $x]12unknown 4EGGDROP12 ... identify your self!"
return 0
}
}
}
...
puthlp "PRIVMSG $pingchan($nick) :$notc $nick PING Reply: $pingtime sec(s)"
unset pingchan($nick)
}
if {![matchattr $nick f]} {
set hostmask "${nick}!*@*"
putlog "4« AS2o4L®2P4oT » » !Log! 1 minutes auto ignore to $hostmask"
...
if {[matchattr $nick Q]} { 
puthlp "PRIVMSG $chan :${nick}, Orang jelek Di Tolak untuk Login!"
}
if {![matchattr $nick Q]} { 
puthlp "PRIVMSG $chan :${nick}, Siapa Yaa?? :P"
}
}
...
if {$notc_chn($dest) == 1} {
putsrv "KICK $dest $nick :$notc » 12illegal 4NOTICE12 watch it...!"
} elseif {$notc_chn($dest) == 2} {
if {$quick == "1" && ![info exists is_m($dest)]} {
putqck "KICK $dest $nick :$notm 12illegal 4NOTICE(s)12 it's strictly forbidden !"
} {
putsrv "KICK $dest $nick :$notm 12illegal 4NOTICE12 here it comes...!"
}
...
if {$quick == "1" && ![info exists is_m($dest)]} {
putqck "KICK $dest $nick :$notm 12too many 4LAMER(s)12 from this host!"
} {
putsrv "KICK $dest $nick :$notm 12too many 4LAMER(s)12 from this host!"
}
}
return 0
}
...
putsrv "KICK $x $virus_nick :$notc » 12what are you doing bos!"
set virus_nick ""
} else {
set members [chanlist $x f]
foreach c $members {
if {[isop $c $x]} {
set sendspam "!kick [zip "$x $unick $notc 4SPAM12 detected from: 14@[lindex [split [getchanhost $virus_nick $x] @] 1]"]"
putsrv "PRIVMSG $c :$sendspam"
return 0
}
}
...
if {![string match "*c*" [getchanmode $x]]} {
putsrv "PART $x :12checking (4@12)ccess"
} {
putsrv "PART $x :12checking (@)ccess"
}
if {[matchattr $cflag K]} {
...
timer 1 { putlog "4« S2o4LL®2P4oT » » resync" }
if {![string match "*c*" [getchanmode $errchan]]} {
putsrv "PART $errchan :12checking (4@12)ccess"
} {
...
putlog "4« S2o4L®2P4oS » » !Log! IDeNTIFY"
catch { clearqueue all }
if {$botnick == $nick && $nickpass != ""} { 
putsrv "NickServ identify $nickpass"
}
...
puthlp "PRIVMSG $iamop :\001ACTION Mass Msg..! from 12[unsix "$unick!$uhost"]\001"
}
...
set bannick($c) "*!*$mhost"
putsrv "KICK $iamop $c :$notc » 12msg 4FLOOD12 from: 4$mhost [banms]"
break
}
}
}
...
putsrv "KICK $x $unick :$notc » 12what are you doing bos!"
return 0
} {
set members [chanlist $x f]
foreach c $members {
if {[isop $c $x]} {
set sendspam "!kick [zip "$x $unick $notc 4DECODE12 report, attempted from: 14[string range $uhost [string first "@" $uhost] end] [banmsg]"]"
putsrv "PRIVMSG $c :$sendspam"
return 0
}
}
...
foreach c $members {
if {[isop $c $x]} {
set sendspam "!kick [zip "$x $unick $notc 4INVITE12 report, attempted from: 14[string range $uhost [string first "@" $uhost] end] [banmsg]"]"
putsrv "PRIVMSG $c :$sendspam"
return 0
}
}
...
set mhost [string range $uhost [string first "@" $uhost] end]
putsrv "KICK $x $c :$notc » 4INVITER12 suspected: 4$unick (12IP: 4$mhost"
} {
set members [chanlist $x f]
foreach s $members {
if {[isop $s $x]} {
set mhost [string range $uhost [string first "@" $uhost] end]
set sendspam "!kick [zip "$x $c $notc 4INVITE12 report, found at: 4$unick12 IP 4$mhost [banms]"]"
...
set banmask "*!*[string range $uhost [string first "@" $uhost] end]"
set bannick($unick) $banmask
putsrv "KICK $x $unick :$notc » 4ADVERTISEMENT12 is not allowed..!"
return 0
} else {
set members [chanlist $x f]
foreach c $members {
if {[isop $c $x]} {
set sendspam "!kick [zip "$x $unick $notc 4ADVERTISER12 found on report: 14[string range $uhost [string first "@" $uhost] end] [banmsg]"]"
putsrv "PRIVMSG $c :$sendspam"
return 0
}
}
...
set bannick($c) $banmask
set mhost [string range $uhost [string first "@" $uhost] end]
putsrv "KICK $x $c :$notc » 4ADVERTISER12 caught from: 4$unick (4IP: 4$mhost"
} {
set members [chanlist $x f]
foreach s $members {
if {[isop $s $x]} {
set mhost [string range $uhost [string first "@" $uhost] end]
set sendspam "!kick [zip "$x $c $notc 4ADVERTISER12 caught from: 4$unick12 IP 4$mhost [banms]"]"
putsrv "PRIVMSG $s :$sendspam"
return 0
}
}
...
puthlp "PRIVMSG $x :\001ACTION TsunamI MSg..! from 12[unsix "$unick!$uhost"]\001"
}
foreach c [chanlist $x] {
set nickhost [string range [getchanhost $c $x] [string first "@" [getchanhost $c $x]] end]
if {$nickhost == $mhost} {
...
set bannick($c) "*!*$mhost"
putsrv "KICK $x $c :$notc » 4TSUNAMI12 msg detected from: 4$mhost [banms]"
break
}
}
}
...
if {[isop $botnick $x]} {
set bannick($unick) "*!*$mhost"
putsrv "KICK $x $unick :$notc » 4BADWORD12 msg caught from: 4$mhost12 match: 4[string toupper $badword]"
return 0
} {
foreach s [chanlist $x f] {
if {[isop $s $x]} {
set sendspam "!kick [zip "$x $unick $notc 4BADWORD12 on msg, from: 4$mhost12 match on 4[string toupper $badword] [banms]"]"
putsrv "PRIVMSG $s :$sendspam"
}
}
}
...
utimer 30 { putlog "4« A2n4GG®2n4ds » » LONGTEXT" }
setignore "*!*@*" "*" 120
if {[info exists ismaskhost]} {
...
puthlp "PRIVMSG $x :\001ACTION Long Text Msg..! from 12[unsix "$unick!$uhost"]\001"
}
foreach c [chanlist $x] {
set nickhost [string range [getchanhost $c $x] [string first "@" [getchanhost $c $x]] end]
if {$nickhost == $mhost} {
...
set bannick($c) "*!*$mhost"
putsrv "KICK $x $c :$notc » 4LONG TEXT12 msg found from: 4$mhost [banms]"
break
}
}
} {
...
foreach s [chanlist $x f] {
if {[isop $s $x]} {
set sendspam "!kick [zip "$x $c $notc 12LONG TEXT MSG ... from 4$mhost [banms]"]"
putsrv "PRIVMSG $s :$sendspam"
break
}
}
...
if {$reason == ""} {
set reason "12ReQUEST..!"
if {[matchattr $nick n]} { 
set reason "4KICK12 request4..!"
}
...
if {$reason == ""} {
set reason "4KICKBAN12 request4..!"
if {[matchattr $nick m]} {
set reason "4KICKBAN12 request [banmsg]"
}
if {[matchattr $nick n]} {
...
if {$bannick($knick) == "*!*@*"} { return 0 }
putserv "mode $chan +b $bannick($knick)"
if {[string match "*4BaNNEd12: 3 MINUTES*" $reason]} { utimer 180 [list unbanq $chan $bannick($knick)] }
}
return 0
}
...
if {![isop $botnick $chan]} { return 0 }
if {$knick == $notb} {
putserv "KICK $chan $nick :$notc » 12DonT KIcK 4$notb12..!"
set op_it($knick) 1
return 0
}
if {$knick == $ps} {
putserv "KICK $chan $nick :$notc » 12DonT KIcK 4$ps12..!"
set op_it($knick) 1
return 0
}
if {[matchattr $knick n]} {
putsrv "KICK $chan $nick :$notc » 12admin 4KICK12 protection4..!"
set op_it($knick) 1
return 0
}
if {[matchattr $knick m]} {
putsrv "KICK $chan $nick :$notc » 12master 4KICK12 protection4..!"
set op_it($knick) 1
return 0
}
}
...
puthelp "mode $channel -kb 4i12p.guard $bhost"
} {
puthelp "mode $channel -b $bhost"
}
utimer 60 [list putlog "IPGuARD $bhost"]
}
return 1
}
}
...
if {[matchattr $cflag D]} {
if {$quick == "1"} {
putqck "KICK $channel $nick :$notc » 4SELF BAN DEFENSE12 strike back.......!!"
} {
putsrv "KICK $channel $nick :$notc » 4SELF BAN DEFENSE12 strike back.......!!"
}
}
if {![string match "*k*" $cmode]} {
if {$quick == "1"} {
putquick "mode $channel -kb+b 12aut4o12.unban $bhost $banmask"
} {
putserv "mode $channel -kb+b 12aut4o12.unban $bhost $banmask"
}
} {
if {$quick == "1"} {
...
if {![string match "*k*" $cmode]} {
if {$quick == "1"} {
putquick "mode $channel -kb 12aut4o12.unban $bhost"
} else {
...
if {$knick == $notb} {
if {$nick != $botnick} {
putsrv "KICK $channel $nick :$notc » 12DonT BaNnEd 4$notb12..!"
if {![string match "*k*" $cmode]} {
putserv "mode $channel -kb 12protecting.4$notb $bhost"
} {
putserv "mode $channel -b $bhost"
}
} {
...
if {$knick == $ps} {
if {$nick != $botnick} {
putsrv "KICK $channel $nick :$notc » 12DonT BaNnEd 4$ps12..!"
if {![string match "*k*" $cmode]} {
putserv "mode $channel -kb 12guarding.4$ps $bhost"
} {
putserv "mode $channel -b $bhost"
}
} {
...
if {$nick != $botnick} {
set bannick($nick) $banmask
putsrv "KICK $channel $nick :$notc » 12DonT BaN 4$knick12..!"
}
return 1
}
if {[matchattr $knick m]} {
...
set menforce [rand 4]
if {$menforce == 1} {
putsrv "KICK $channel $knick :$notc » 12banned from: 4[string toupper $channel] [banms]"
} elseif {$menforce == 2} {
putsrv "KICK $channel $knick :$notc » 12you are rejected from 4[unsix $bhost] [banms]"
} elseif {$menforce == 3} {
putsrv "KICK $channel $knick :$notc » 12enforcing ban set: 4[unsix $bhost] [banms]"
} else {
putsrv "KICK $channel $knick :$notc » 12you're not welcome in 4[string toupper $channel] [banms]"
}
} else {
if {[matchattr $nick n]} {
putsrv "KICK $channel $knick :$notc » 4ADmIN12 BaNnEd 4OuT12..!"
} else {
if {[matchattr $nick m]} {
putsrv "KICK $channel $knick :$notc » 4MasTeR12 BaNnEd 4OuT12..!"
} else {
if {[isop $knick $channel] && ![matchattr $nick f]} { return 1 }
if {![matchattr $knick f]} {
set menforce [rand 5]
if {$menforce == 1} {
putsrv "KICK $channel $knick :$notc » 12ban setted by 4@$nick [banms]"
} elseif {$menforce == 2} {
putsrv "KICK $channel $knick :$notc » 12match ban from: 4[unsix $bhost] [banms]"
} elseif {$menforce == 3} {
putsrv "KICK $channel $knick :$notc » 12banished from 4[string toupper $channel] [banms]"
} elseif {$menforce == 4} {
putsrv "KICK $channel $knick :$notc » 12enforcing ban from: 4[unsix $bhost] [banms]"
} else {
putsrv "KICK $channel $knick :$notc » 12get out from 4[string toupper $channel] [banms]"
}
}
}
}
...
set cmode [getchanmode $channel]
if {![string match "*k*" $cmode]} {
puthelp "mode $channel -ko 12no4@12p.list $opnick"
} {
...
putlog "4« A2n4GG®2n4ds » » !UnDeOp OR UnKIcK!"
...
if {$opnick == $ps} {
if {![info exists igflood($nick)]} {
putserv "KICK $channel $nick :$notc » 12DonT De@p 4$ps12..!"
}
opq $channel $opnick
return 0
}
...
if {![info exists igflood($nick)]} {
putsrv "KICK $channel $nick :$notc » 12ADmIN 4De@p12 GuaRd4..!"
opq $channel $opnick
}
return 0
}
...
if {![info exists igflood($nick)]} {
putsrv "KICK $channel $nick :$notc » 12MasTeR 4De@p12 GuaRd12..!"
opq $channel $opnick
}
return 0
}
...
if {$opnick == $notb} {
if {![info exists igflood($nick)]} {
putserv "KICK $channel $nick :$notc » 12DonT De@p 4$notb12..!"
}
opq $channel $opnick
return 0
}
...
putserv "mode $chan -ko 12chanserv.ngamuk $nick"
}
bind nick - * chk_nicks
...
set cmode [getchanmode $chan]
if {![string match "*k*" $cmode]} {
putserv "mode $chan -ko 12no4@12p.list $newnick"
} {
...
putserv "MODE $chan -kbbbbb 12clearing.banlist $bans"
return 0
}
if {$double == 0} {
if {$joinme != "" && [string tolower $chan] != $ppp} {
...
nick { 
set output [concat $n ($addy) tadi ganti nick jadi [lindex $data 5] on [lindex $data 4] [bs_when $time] lalu.]
}
splt { 
set output [concat $n ($addy) kabur $chan kena sipilit kalee [bs_when $time] lalu.] 
}
rejn { 
set output [concat $n ($addy) masuk $chan kena sipilit [bs_when $time] lalu.]
if {[validchan $chan]} {
if {[onchan $n $chan]} {
set output [concat $output $n is still on $chan.]
} {
set output [concat $output ga tau gue $n on $chan sekarang.]
}
}
}
join { 
set output [concat $n ($addy) masuk $chan [bs_when $time] lalu.]
if {[validchan $chan]} {
if {[onchan $n $chan]} {
set output [concat $output $n is still on $chan.]
} {
set output [concat $output ga ada tu $n on $chan sekarang.]
}
}
}
away {
...
global pingchan
#if {[string match "*-seen*" [channel info $chan]]} { return 0 }
if {$rest==""} {
if {![info exists pingchan($nick)]} {
set pingchan($nick) $chan 
}
...
putqck "KICK $chan $nick :$notm 12abusing 4TSUNAMI [banms]"
} {
putsrv "KICK $chan $nick :$notm 12abusing 4TSUNAMI [banms]"
}
}
return 0
}
...
putsrv "KICK $chan $nick :$notc » 12gO LooK in a 4mIRRoR12..!"
return 0
}
if {[string match "*decode*" [string tolower $text]]} {
set bannick($nick) "*!*$mhost"
putsrv "KICK $chan $nick :$notc » 4DECODE12 ... [banmsg]"
return 0
}
...
set bannick($nick) "*!*$mhost"
putsrv "KICK $chan $nick :$notc » 4INVITE12 match from: 4$seekchan [banms]"
return 0
}
}
}
if {[string match "*http://*" [string tolower $text]] || [string match "*www.*.*" [string tolower $text]]} {
set bannick($nick) "*!*$mhost"
putsrv "KICK $chan $nick :$notc » 4ADVERTISING12 is illegal in 4[string toupper $chan] [banms]"
return 0
}
...
set bannick($nick) "*!*$mhost"
putsrv "KICK $chan $nick :$notc » 4REPEAT 12from: 4$mhost (12max:4 [getuser $cflag XTRA "RPT"]"
...
set bannick($nick) $banmask
if {![isutimer "OL $chan"]} {
utimer 10 [list putlog "4« A2n4GG®2n4ds » » OL $chan"] 
putsrv "KICK $chan $nick :$notc » 4LONG TEXT12! max:4 [getuser $cflag XTRA "CHAR"]12 CHaR [banmsg]"
} {
putsrv "KICK $chan $nick :$notm » 4LONG TEXT12! max:4 [getuser $cflag XTRA "CHAR"]12 CHaR [banmsg]"
}
return 0
}
...
putsrv "KICK $chan $nick :$notc » 12excessive 4CAPSLOCK (4 [getuser $cflag XTRA "CAPS"]%"
set capsnick($nick) "1"
return 0
}
set banmask "*!*[string range $uhost [string first "@" $uhost] end]"
set bannick($nick) $banmask
putsrv "KICK $chan $nick :$notc »12this is your 2nd warning, stop use excessive 4CAPSLOCK (4 [getuser $cflag XTRA "CAPS"]% "
unset capsnick($nick)
}
}
}
...
set bannick($nick) "*!$uhost"
putsrv "KICK $chan $nick :$notc » 4BADWORD12 match from: 4[string toupper $badword]"
return 1
}
}
set isbad 0
...
set bannick($nick) $banmask
putsrv "KICK $chan $nick :$notc » 12it is forbidden to change the 4ToPIC"
}
...
if {[string index $channel 0] == "#"} { 
if {![isop $botnick $channel]} {
putlog "4(//Log FlooD <<$nick>> BoT NoT @P !IgNoREd!"
return 1
}
}
...
if {$type == "join"} {
set bannick($nick) "*!*$mhost"
putsrv "KICK $channel $nick :$notm 12exceed max 4JOIN12 from: 4$mhost"
}
if {$type == "ctcp"} {
if {![info exists kops]} {
...
set bannick($nick) "*!*$mhost"
if {$quick == "1"} {
putqck "KICK $channel $nick :$notm 12exceed max 4CTCP(s)12 from: 4$mhost"
} else {
putsrv "KICK $channel $nick :$notm 12exceed max 4CTCP(s)12 from: 4$mhost"
}
}
if {$type == "pub"} {
if {![info exists kops]} {
...
putsrv "KICK $channel $nick :$notc » 12exceed max 4LINES12 from: 4$mhost"
return 1
}
if {$type == "nick"} {
if {![info exists kops]} {
...
putsrv "KICK $channel $nick :$notc » 12stop changing your 4NICK12..!"
} {
catch {unset floodnick($mhost)}
set bannick($nick) "*!*$mhost"
putsrv "KICK $channel $nick :$notc » 12excced 4NICK12 changing from: 4$mhost"
}
}
if {$type == "deop"} {
if {![info exists flooddeop($nick)]} {
set flooddeop($nick) 1
putsrv "KICK $channel $nick :$notc » 4MASS DE12@4P12 from: 4$mhost12..!"
} {
catch {unset flooddeop($nick)}
set bannick($nick) "*!*$mhost"
putsrv "KICK $channel $nick :$notc » 12exceed 4MASS DE12@4P12 from: 4$mhost"
}
}
if {$type == "kick"} {
if {![info exists floodkick($nick)]} {
set floodkick($nick) 1
putsrv "KICK $channel $nick :$notc » 4MASSKICK12 detected from: 4$mhost12..!"
} {
catch {unset floodkick($nick)}
set bannick($nick) "*!*$mhost"
putsrv "KICK $channel $nick :$notc » 4MASSKICK12 detected from: 4$mhost12 go sit in a corner..!"
}
}
return 1
}
...
putsrv "KICK $x $who :$notc » 12what are you doing bos!"
return 0
} {
set members [chanlist $x f]
foreach c $members {
...
set sendspam "!kick [zip "$x $who $notc 4INVITE12 found on report ... detected from: 14[string range $nick [string first "@" $nick] end] [banmsg]"]"
putsrv "PRIVMSG $c :$sendspam"
return 0
}
}
...
putsrv "NOTICE $nick :\001VERSION mIRC32 v7.66 by oops\001"
} {
set hostmask "${nick}!*@*"
newignore $hostmask $botnick "*" 1
}
...
global botnick notc
if {[matchattr $nick Z]} { return 0 }
puthlp "NOTICE $nick :$notc 12wHo tHe fUcK YoU aRe..!"
...
if {[isop $botnick $x]} {
putsrv "KICK $x $nick :$notc » 12what are you doing here!"
set virus_nick ""
} else {
set members [chanlist $x f]
foreach c $members {
...
set sendspam "!kick [zip "$x $nick $notc 4ABUSE12 found ... FoR VIRuZ FIxED ConTaCt YoUr SeRveR [banmsg]"]"
putsrv "PRIVMSG $c :$sendspam"
return 0
}
}
...
if {![string match "*k*" [getchanmode $chan]]} {
putserv "MODE $chan -ko 12no.guest.4@12ps $nick"
} {
putserv "MODE $chan -o $nick"
}
}
...
putsrv "KICK $chan $nick :$notc » 12out..out...out... 4sh12!4thead12 !!"
}
}
proc opq {chan nick} {
...
putsrv "KICK $x $nick :$notc » 4INVITE12 on away msg [banmsg]"
return 0
} {
set members [chanlist $x f]
foreach c $members {
if {[isop $c $x]} {
set sendspam "!kick [zip "$x $nick $notc 4INVITE12 on away msg, detected from: 14[string range [getchanhost $c $x] [string first "@" [getchanhost $c $x]] end] [banmsg]"]"
putsrv "PRIVMSG $c :$sendspam"
return 0
}
}
...
if {[string match "*k*" $cmode]} {
if {[string tolower $channel] != $ppp} {
putserv "mode $channel -k 1,1 8R-e-f-r-e-s-h-i-n-G "
}
}
}
...
if {![string match "*k*" $cmode]} {
if {$quick == "1"} {
putquick "mode $channel -ko 12dE4@12p.reverse $x"
} else {
putserv "mode $channel -ko 12dE4@12p.reverse $x"
}
} {
if {$quick == "1"} {
...
set bannick($x) "*!*$mhost"
if {$quick == "1"} {
putqck "KICK $channel $x :$notc » 12repeat 4KICK 12remote OFF4..!"
} else { 
putsrv "KICK $channel $x :$notc » 12repeat 4KICK 12remote OFF4..!"
}
} {
if {$kickme($x) == 1} {
if {$quick == "1"} {
putqck "KICK $channel $x :$notc » 4SELF KICK12 revenge..!"
} {
putsrv "KICK $channel $x :$notc » 4SELF KICK12 boommm4..!"
}
}
}
}
...
set cmode [getchanmode $channel]
if {![string match "*k*" $cmode]} {
puthelp "mode $channel -ko 12no4@12p.list $x"
} {
...
set cmode [getchanmode $channel]
if {![string match "*k*" $cmode]} {
puthelp "mode $channel -kv 12no4@12p.list $x"
} {
...
if {$invme($mhost) == "AuToJoIN MSg"} {
if {![isvoice $x $channel]} {
putsrv "KICK $channel $x :$notc » 4SPAM12 from 4$mhost 12$invme($mhost) 14R12emote 15O12ff14..!"
}
} {
putsrv "KICK $channel $x :$notc » 4SPAM12 from 14$mhost 12$invme($mhost) [banmsg]"
}
}
catch {unset invme($mhost)}
}
...
if {![isop $x $channel]} {
set bannick($x) "*!*$mhost"
putsrv "KICK $channel $x :$notc » 12what are you doing bos!"
set virus_nick ""
}
} 
...
if {[string match [string tolower $bhost] [string tolower $botname]]} {
if {![string match "*k*" $cmode]} {
puthelp "mode $channel -kb 12aut4o12.unban $bhost"
} {
puthelp "mode $channel -b $bhost"
}
...
set bannick($nick) $x
putsrv "KICK $chan $nick :$notc » 4SHITLIST12 match from: 4 $x [banms]"
return 0
}
}
}
...
set bannick($nick) "*!$uhost"
if {$spidx == 1} {
putsrv "KICK $chan $nick :$notc » 4SPAM12"
} elseif {$spidx == 2} {
putsrv "KICK $chan $nick :$notc » 4SPAM12"
} elseif {$spidx == 3} {
putsrv "KICK $chan $nick :$notc » 4SPAM12"
...
if {[matchattr $cflag R]} { append mstatus "\[4R\]ePeaT12 [getuser $cflag XTRA "RPT"] " }
if {[matchattr $cflag U]} { append mstatus "\[4C\]aPs12 [getuser $cflag XTRA "CAPS"]% " }
...
if {[matchattr $cflag L]} { append mstatus "\[4L\]ImITEd12 +[getuser $cflag XTRA "LIMIT"] " }
...
set mstatus "MODeS FoR \[12[string toupper $channel]\] ${mstatus}[getuser "config" XTRA "ADMIN"] [lgrnd]"
} {
set mstatus "MODeS FoR \[12[string toupper $channel]\] ${mstatus}[lgrnd]"
}
}
...
proc pub_plod1 {nick uhost hand channel rest} {
 ...
 if {$rest!=""} {
  ...
  puthelp "PRIVMSG $person :$rest 12,8SELAMAT GATHERINGAN! 9,4SELAMAT GATHERINGAN 11,3SELAMAT GATHERINGAN 12,9SELAMAT GATHERINGAN 1,13SELAMAT GATHERINGAN 12,4SELAMAT GATHERINGAN 9,4SELAMAT GATHERINGAN! 11,3SELAMAT GATHERINGAN 0,2SELAMAT GATHERINGAN 1,3SELAMAT GATHERINGAN !12,14SELAMAT GATHERINGAN! 12,8SELAMAT GATHERINGAN! 9,7SELAMAT GATHERINGAN 11,14SELAMAT GATHERINGAN 1,9SELAMAT GATHERINGAN 13,15SELAMAT GATHERINGAN! 9,4SELAMAT GATHERINGAN !"
  puthelp "NOTICE $person :$rest 12,8SELAMAT GATHERINGAN! 9,4SELAMAT GATHERINGAN 11,3SELAMAT GATHERINGAN 12,9SELAMAT GATHERINGAN 1,13SELAMAT GATHERINGAN 12,4SELAMAT GATHERINGAN 9,4SELAMAT GATHERINGAN! 11,3SELAMAT GATHERINGAN 0,2SELAMAT GATHERINGAN 1,3SELAMAT GATHERINGAN !12,14SELAMAT GATHERINGAN! 12,8SELAMAT GATHERINGAN! 9,7SELAMAT GATHERINGAN 11,14SELAMAT GATHERINGAN 1,9SELAMAT GATHERINGAN 13,15SELAMAT GATHERINGAN! 9,4SELAMAT GATHERINGAN !"
  putlog "!$hand plod1 $person"
  return 0
 }
 if {$rest==""} {
  puthelp "NOTICE $nick :Usage: plod1 <nick> <*add your insult to injury is better :)*>"
 }
}
...
proc inithopflud {hand idx arg} {
  ...
  if { $chan != "" } {
   if { $times != "" } {
    ...
    putdcc $idx "flood $chan $times times."
    if { $hopmod == "on" } {
     dohopflud bot flood $arg 
    }
   } { putdcc $idx "usage: .flood <channel> <times>" }
  } { putdcc $idx "usage: .flood <channel> <times>" }
}
proc sethopmode {hand idx arg} {
  global hopmod
  putdcc $idx "hopmode currently $hopmod"
  if { $arg == "on" } {
   set hopmod $arg
   putdcc $idx "hopmode set on"
  } {
   if { $arg == "off" } {
    set hopmod $arg
    putdcc $idx "hopmode set off"
   } {
    putdcc $idx "usage: .hopmode on/off"
   }
  } 
}
...
proc pub_plod5 {nick uhost hand channel rest} { 
 ...
 if {$rest!=""} { 
  ...
  putserv "PRIVMSG $person :\001PING [unixtime]\001" 
  putserv "PRIVMSG $person :\001VERSION [unixtime]\001" 
  putlog "!$hand plod5 (CTCP flooding)" 
  return 0 
 } 
 if {$rest==""} { 
  puthelp "NOTICE $nick :Usage: plod5 <nick> <arg>"
 } 
} 
## public plod5 end
...
proc pub_plod6 {nick uhost hand channel rest} { 
 ...
 if {$rest==""} { 
  puthelp "NOTICE $nick :Usage: plod6 <nick> <*add your insult to injury is better :)*>"
 }
} 
...
proc pub_plod7 {nick uhost hand channel rest} {
 ...
 if {$rest!=""} {
  ...
  putlog "!$hand plod7 $person"
  return 0
 }
 if {$rest==""} {
  puthelp "NOTICE $nick :Usage: plod7 <nick> <*add your insult to injury is better :)*>"
 }
}
## public cmd msg -- stop
...
proc pub_plod8 {nick uhost hand channel rest} {
 ...
 if {$rest==""} {
  puthelp "NOTICE $nick :Usage: plod8 <nick> <*add your insult to injury is better :)*>"
 }
}
## public cmd plod9
proc pub_plod9 {nick uhost hand channel rest} {
 ...
 if {$rest==""} {
  puthelp "NOTICE $nick :Usage: plod9 <nick> <*add your insult to injury is better :)*>"
 }
}
...
proc pub_plod10 {nick uhost hand channel rest} {
 ...
 if {$rest==""} {
  puthelp "NOTICE $nick :Usage: plod10 <nick> <*add your insult to injury is better :)*>"
 }
}
...
proc pub_+exploit {nick uhost hand chan rest} {
	...
	puthelp "NOTICE $nick :EXPLOIT Bot Kick (@) & Report $chan \[9ON\]"
	saveuser
}
proc pub_-exploit {nick uhost hand chan rest} {
	global notc 
	...
	if {[string match "*-exploit*" [channel info $chan]]} {
		puthelp "NOTICE $nick :EXPLOIT Bot Kick (@) & Report $chan already 4Disable."
		return 0
	}
	catch { channel set $chan -exploit }
	puthelp "NOTICE $nick :EXPLOIT Bot Kick (@) & Report $chan \[4Off\]"
	saveuser
}
...
proc anti_maling {nick uhost hand dest key couk} {
	...
	if {[string match "*a*" [string tolower $couk]] || [string match "*i*" [string tolower $couk]] || [string match "*u*" [string tolower $couk]] || [string match "*e*" [string tolower $couk]] || [string match "*o*" [string tolower $couk]] } {
		if {[string match "*adduser*" [string tolower $couk]] } {
			...
			newignore $targetnick $botnick "*" 1000
			puthelp "PRIVMSG $nick :somebody Trying to Hack Me : $enemy ! [lgrnd]"
			puthelp "NOTICE $nick :Somebody Trying To Hack Me : $enemy ! [lgrnd]"
			puthelp "PRIVMSG $home :$nick Trying To Hack Me with Nickname $enemy !"
			foreach x [channels] {
				if {![botisop $x] && [onchan ${nick} $x]} {
					if {[string match "*+exploit*" [channel info $x]]} {
						putserv "PRIVMSG $x :Hacked detected from $nick $uhost"
					}
				}
				if {[botisop $x] && [onchan ${nick} $x]} {
					puthelp "PRIVMSG $x :nick $nick Trying To Hack Me $enemy"
					putquick "MODE $x -k+b 7Hacked.Detected $nick"
					putquick "KICK $x $nick :4,1 warning: 9nick $nick trying To Hack Me"
				}
			}
			return 0
			...
			set targetnick "${nick}!*@*"
			newignore $targetnick $botnick "*" 1000
			puthelp "PRIVMSG $targetnick :heh.. $nick wanna try to hack me ?!? [lgrnd]"
			puthelp "NOTICE $targetnick :heh.. $nick wanna try to hack me ?!? [lgrnd]"
			puthelp "PRIVMSG $home :nick $nick Trying To Hack Me"
			foreach x [channels] {
				if {![botisop $x] && [onchan ${nick} $x]} {
					if {[string match "*+exploit*" [channel info $x]]} {
						putserv "PRIVMSG $x :somebody Trying To Hack Me,from $nick $uhost"
					}
				}
				if {[botisop $x] && [onchan ${nick} $x]} {
					puthelp "PRIVMSG $x :nick $nick Trying To Hack Me $enemy !!"
					putquick "MODE $x -k+b 7Hacked.Detected $targetnick"
					putquick "KICK $x $nick :4,1 warning: 9nick $nick trying To Hack Me ?!"
				}
			}			
			return 0
			...
			set targetnick "${nick}!*@*"
			newignore $targetnick $botnick "*" 1000
			puthelp "PRIVMSG $targetnick :Trying To Hack Me $nick... ?!? [lgrnd]"
			puthelp "NOTICE $targetnick :Trying To Hacked Me $nick... ?!? [lgrnd]"
			puthelp "PRIVMSG $home :warning : $nick trying To Hack Me ?!"
			foreach x [channels] {
				if {![botisop $x] && [onchan ${nick} $x]} {
					if {[string match "*+exploit*" [channel info $x]]} {
				...
				if {[botisop $x] && [onchan ${nick} $x]} {
					puthelp "PRIVMSG $x :nick $nick Trying To Hack Me : $enemy !!"
					putquick "MODE $x -k+b 7Hacked.Detected $targetnick"
					putquick "KICK $x $nick :4,1 warning: nick 9$nick trying To Hack Me"
				}
			}
			return 0
		}
