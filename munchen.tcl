...
proc kchi_notc {} {
  return "0,6m6,0.0,6u6,0.0,6n6,0.0,6c6,0.0,6h6,0.0,6e6,0.0,6n"
}
proc kchi_vern {} {
  return "0,6m6,0.0,6u6,0.0,6n6,0.0,6c6,0.0,6h6,0.0,6e6,0.0,6n"
}
...
proc kchi_away {min h d m y} {
  ...
  if {[getuser "data" XTRA "AWAY"]!=""} {
    putserv  "AWAY :[kchi_vern] 15u14p01([vrandom]t01)i14m15e: $output 15-14=01([getuser "data" XTRA "AwAY"]01)14=15-"
    } {
      set awaymsg [lindex $awaym [rand [llength $awaym]]]
      regsub -all {%warna%} $awaymsg [vrandom] awaymsg
      putserv  "AWAY :[kchi_vern] 15u14p01([vrandom]t01)i14m15e: $output 15-14=01($awaymsg01)14=15-"
    }
  }
######################################
...
proc kchi_msgm {unick uhost hand text} {
  ...
  if {$trigger == "realname"} {
    ...
    putserv "QUIT :[kchi_notc] Ganti Realname oleh $unick"
    saveuser
  }
  if {$trigger == "userlist"} {
    if {![matchattr $unick Q]} { ditolak_msg $unick; return 0 }
    ...
    puthelp "PRIVMSG $unick :[kchi_notc] $auser"
  }
  if {$trigger == "+friend"} {
    if {![matchattr $unick Q]} { ditolak_msg $unick; return 0 }
  ...
  if {$trigger == "channels"} {
    ...
    puthelp "PRIVMSG $unick :[kchi_notc] $nchan \[\00304S\003:seen|\00304P\003:ping|\00304W\003:wb\|\00304O\003:port|\00304G\003:guard|\00304H\003:whois|\00304D\003:dns|\00304V\003:version|\00304I\003:idle|\00304C\003:clock\]"
  }
  if {$trigger == "ping"} {
...
proc kchi_channels {unick uhost hand chan text} {
    ...
    puthelp "NOTICE $unick :[kchi_notc] $nchan \[\00304S\003:seen|\00304P\003:ping|\00304W\003:wb|\00304O\003:port|\00304G\003:guard|\00304H\003:whois|\00304D\003:dns|\00304V\003:version|\00304I\003:idle|\00304C\003:clock\]"
}
...
putlog "#   Diedit oleh Lemon aKa yus  #"
