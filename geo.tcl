...
set geoip(version) "geo2020"
set geoip(trigger) ".geo"
set geoip(trigger2) "!geo"
...
proc pub_geoip {nick uhost hand chan text} {
  ...
  if {$results==0} {
   ...
   putserv "PRIVMSG $chan :\00310IP:\00304 $ip"
   putserv "PRIVMSG $chan :\00310Hostname:\00307 $hostname"
   putserv "PRIVMSG $chan :\00310Kota:\00307 $city"
   putserv "PRIVMSG $chan :\00310Daerah:\00307 $region"
   putserv "PRIVMSG $chan :\00310Kodepos:\00307 $postal"
   putserv "PRIVMSG $chan :\00310Lokasi:\00307 $loc" 
   putserv "PRIVMSG $chan :\00310Negara:\00304 $country \00301\(\00306$countryname\00301\)"
   putserv "PRIVMSG $chan :\00310Perusahaan:\00314 $org"
} 

putlog "geo.tcl v$geoip(version) loaded."
